...
const Menu = () => {
  ...
  return (
    ...
    >
      ...
      >
        {asPath.startsWith('/calendar') && <CalendarSidebar />}
        {asPath.startsWith('/journal') && <JournalSidebar />}
      </div>

      {!asPath.startsWith('/calendar') && !asPath.startsWith('/journal') && (
        <div
          className={clsx(
        ...
        >
          ...
          <div className="relative flex h-full w-full flex-col p-2 md:flex-row">
            ...
            >
              ...
              <div className="relative flex h-full w-full flex-col rounded p-2">
                <div className="text-lg">{sessionData?.user.name}</div>
                <div className="text-xs opacity-50">{sessionData?.user.id}</div>
                <div
                  className={clsx(
                    'relative mt-2 flex h-full w-full flex-col items-center justify-center rounded',
                    {
                      'bg-darkThemeBG': isDarkTheme,
                      'bg-lightThemeBG': !isDarkTheme,
                    }
