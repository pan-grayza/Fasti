...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="relative flex h-fit w-full flex-col overflow-y-auto overflow-x-hidden">
        <section className="relative flex h-[calc(100vh-3.5rem)] w-full shrink-0 items-center justify-center">
        ...
        <section className="relative flex h-[calc(100vh-3.5rem)] w-full shrink-0 flex-col p-4 md:p-12">
          <div className="h-56">
        ...
        <section className="relative flex h-[calc(100vh-3.5rem)] w-full shrink-0 flex-col">
        ...
        <footer
          className={clsx(
            'relative flex h-[calc(100vh-3.5rem-8rem)] w-full shrink-0 flex-col items-center justify-center p-4 md:flex-row'
          )}
        >
