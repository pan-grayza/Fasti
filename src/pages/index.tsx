...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="relative flex h-fit w-full snap-y snap-mandatory flex-col overflow-y-auto overflow-x-hidden">
        <section className="relative flex h-[calc(100vh-3.5rem)] w-full shrink-0 snap-center items-center justify-center">
        ...
        <section className="relative flex h-[calc(100vh-3.5rem)] w-full shrink-0 snap-center flex-col p-4 md:p-12">
          <div className="h-56">
        ...
        <section className="relative flex h-[calc(100vh-3.5rem)] w-full shrink-0 snap-center flex-col">
          ...
          <div
            className={clsx(
              'relative flex h-32 w-full shrink-0 flex-col items-center justify-center gap-2 border-t',
              {
        ...
        <footer
          className={clsx(
            'relative flex h-[calc(100vh-3.5rem-8rem)] w-full shrink-0 snap-end flex-col items-center justify-center p-4 md:flex-row'
          )}
        >
          ...
          <div className="relative flex h-full w-1/2 flex-col items-center justify-center gap-2">
            <h1 className="text-4xl font-bold">Contact me</h1>
            <p className="text-xl">zagraystepan@gmail.com</p>
          </div>
        </footer>
      </div>
    </>
